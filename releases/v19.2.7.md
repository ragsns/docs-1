...
- A data race on AST nodes for [`SELECT` statements](../v19.2/select-clauses.html) that include a [`WINDOW` definition](../v19.2/window-functions.html#window-definitions) has been fixed. Previously, these queries could have returned incorrect results. [#47176][#47176]
...
- Fixed a bug causing cascading [deletes](../v19.2/deletes.html) to fail when deleting thousands of rows across interleaved tables. [#48287][#48287]
...
- Fixed a rare bug where stats refreshes could fail. CockroachDB now triggers stats refreshing after completing an [import](../v19.2/import.html) job, after the transaction finishes the [job](../v19.2/jobs.html) commits. [#48028][#48028]
...
[ca2a4f1ef]: https://github.com/cockroachdb/cockroach/commit/ca2a4f1ef
